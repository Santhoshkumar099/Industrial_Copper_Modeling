...
selected = option_menu(None, ['🏡HOME',"💸PRICE PREDICTION","🏆STATUS","🎯CONCLUSION"],
        ...
        if 'PRICE PREDICTION':
            ...
            with c1:
                ...
                if st.button('PREDICT PRICE'):
                    ...
                    with open('F:\IT Field\Python01\MDTM20\Project04\status.pkl', 'rb') as file:
                    ...
                    with open('F:\IT Field\Python01\MDTM20\Project04\scaling_Reg.pkl', 'rb') as file:
                        scaled_data = pickle.load(file)

                    with open('F:\IT Field\Python01\MDTM20\Project04\Model_RFR.pkl', 'rb') as f:
                        model = pickle.load(f)
